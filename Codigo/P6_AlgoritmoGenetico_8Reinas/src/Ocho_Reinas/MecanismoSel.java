...
public class MecanismoSel {
    ...
    public ArrayList<Integer> seleccionaTorneo(ArrayList<Integer> aptitudes, int k){
    ...
    public ArrayList<Integer> seleccionaRuleta(ArrayList<Integer> aptitudes, int k){
